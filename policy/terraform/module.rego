# This policy evaluates a terraform plan, and ensures that any instances
# of a specific resource type are managed exclusively through the
# appropriate module.
package terraform
